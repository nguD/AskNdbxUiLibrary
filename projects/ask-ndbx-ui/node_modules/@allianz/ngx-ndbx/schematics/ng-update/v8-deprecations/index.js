...
function default_1() {
    return (tree, context) => {
        ...
        logger.info('With version 8 we removed deprecations from version 7.');
...
const runAttributeMigrations = (tree, tsConfigPath, context) => {
    ...
    resolvedTemplates.forEach((template) => {
        ...
        const newHtmlContent = migrate_html_1.migrateHtml(attribute_upgrade_data_1.attributeChangeV8, template.content, template.container.getSourceFile().fileName);
        if (newHtmlContent) {
            if (template.inline) {
