 ...
 * @docs-private
 */
export declare class NxCalendarComponent<D> implements AfterContentInit, OnDestroy, OnChanges {
    private _intl;
    ...
    constructor(_intl: NxDatepickerIntl, _dateAdapter: NxDateAdapter<D>, _dateFormats: NxDateFormats, changeDetectorRef: ChangeDetectorRef);
