:root {
  ...
  --ui-05: #F5F5F5;
  --ui-06: white;
  --interactive-text: #FF6200;
  --interactive-primary: #FF6200;
  --hover-primary: #ff721a;
  --hover-secondary: #5B5B5B;
  --active-primary: #b34500;
  --hover-link: #ff8133;
  --focus-box-shadow: 0 0 0 2px #ffffff, 0 0 0 6px #009DE6;
  ...
  --badge-vibrant-background-color: var(--ui-03);
  ...
  --button-primary-disabled-background-color: rgba(255, 98, 0, 0.4);
  ...
  --button-secondary-text-color: var(--text-01);
  ...
  --button-secondary-disabled-text-color: rgba(255, 98, 0, 0.4);
  --button-secondary-disabled-border-color: rgba(255, 98, 0, 0.4);
  ...
  --card-background-selected-color: #767676;
  ...
  --dropdown-panel-header-background-color: #FF6200;
  ...
  --menu-button-nested-expanded-background-color: #ff914d;
  --menu-button-nested-expanded-border-color: #ff914d;
  ...
  --modal-background-color: var(--ui-02);
  ...
  --slider-handle-background-color: #F5F5F5;
  ...
  --slider-value-background-color: #F5F5F5;
  ...
  --slider-handle-active-inset-color: rgba(255, 98, 0, 0.2);
  ...
  --taglist-hover-background-color: #C2C2C2;
  ...
  --zebra-table-row-selected-background-color: #5B5B5B;
  ...
  --toggle-button-disabled-border-color: rgba(255, 98, 0, 0.4);
  --toggle-button-disabled-text-color: rgba(179, 69, 0, 0.4);
  --toggle-button-disabled-selected-background-color: rgba(255, 98, 0, 0.4);
