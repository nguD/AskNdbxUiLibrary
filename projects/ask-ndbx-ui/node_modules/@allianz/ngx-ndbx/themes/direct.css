:root {
  ...
  --interactive-primary: #407D71;
  --hover-primary: #407D71;
  --hover-secondary: #ECECEC;
  --active-primary: #407D71;
  --hover-link: #008ED6;
  --focus-box-shadow: 0 0 0 2px #ffffff, 0 0 0 4px #407D71;
  --focus-inset-box-shadow: inset 0 0 0 4px #407D71, inset 0 0 0 6px #ffffff;
  --text-01: #000000;
  --text-02: #FFFFFF;
  --info: #496EBD;
  --warning: #EFBE25;
  ...
  --button-primary-background-color: #003781;
  --button-primary-border-color: transparent;
  --button-primary-text-color: #ffffff;
  --button-primary-hover-background-color: #0062C0;
  --button-primary-hover-border-color: transparent;
  --button-primary-hover-text-color: #ffffff;
  --button-primary-active-background-color: #002567;
  --button-primary-active-text-color: #ffffff;
  --button-primary-active-border-color: transparent;
  --button-primary-disabled-background-color: #ECECEC;
  --button-primary-disabled-text-color: #999999;
  --button-primary-disabled-border-color: transparent;
  --button-secondary-background-color: #E4E7ED;
  --button-secondary-border-color: transparent;
  --button-secondary-text-color: #003781;
  --button-secondary-hover-background-color: #EDEFF2;
  --button-secondary-hover-border-color: transparent;
  --button-secondary-hover-text-color: #0062C0;
  --button-secondary-active-background-color: #D7DBE0;
  --button-secondary-active-text-color: #003781;
  --button-secondary-active-border-color: transparent;
  --button-secondary-disabled-background-color: #ECECEC;
  --button-secondary-disabled-text-color: #999999;
  ...
  --link-color: #006192;
  --link-hover-color: var(--hover-primary);
  ...
  --progressbar-background-color: rgba(245, 190, 156, 0.5);
  --progressbar-indicator-color: #F86200;
  ...
  --radio-button-hover-dot-color: white;
  --radio-button-selected-dot-color: white;
  ...
  --radio-button-disabled-selected-dot-color: white;
  ...
  --switcher-unchecked-background-color: #c2c2c2;
