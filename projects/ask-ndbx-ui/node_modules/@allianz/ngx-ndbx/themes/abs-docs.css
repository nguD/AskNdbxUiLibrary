...
:root {
  ...
  --interactive-primary: #006289;
  --hover-primary: #006192;
  --hover-secondary: #ECECEC;
  --active-primary: #003781;
  --hover-link: #008ED6;
  --focus-box-shadow: 0 0 0 1px #fff, 0 0 0 3px #009de6;
  --focus-inset-box-shadow: inset 0 0 0 4px #009DE6, inset 0 0 0 6px #ffffff;
  --text-01: #414141;
  --text-02: #FFFFFF;
  --info: #496EBD;
  --warning: #EFBE25;
  ...
  --accordion-light-mobile-font-size: var(--paragraph-04-font-size);
  --accordion-light-mobile-line-height: var(--paragraph-04-line-height);
  --accordion-light-mobile-font-weight: var(--paragraph-04-font-weight);
  --accordion-light-mobile-letter-spacing: var(--paragraph-04-letter-spacing);
  ...
  --base-label-small-font-size: 0.8rem;
  --base-label-small-line-height: 18px;
  --base-label-small-font-weight: normal;
  --base-label-small-letter-spacing: 0;
  ...
  --button-primary-disabled-background-color: var(--disabled-01);
  --button-primary-disabled-text-color: #fff;
  ...
  --button-secondary-hover-background-color: #e5e5f3;
  --button-secondary-hover-border-color: var(--interactive-primary);
  --button-secondary-hover-text-color: var(--interactive-primary);
  --button-secondary-active-background-color: #ccdbe2;
  --button-secondary-active-text-color: var(--interactive-primary);
  --button-secondary-active-border-color: var(--interactive-primary);
  --button-secondary-disabled-background-color: transparent;
  --button-secondary-disabled-text-color: var(--disabled-01);
  --button-secondary-disabled-border-color: var(--disabled-01);
  ...
  --button-cta-background-color: #ccc;
  --button-cta-border-color: transparent;
  --button-cta-text-color: #333;
  --button-cta-hover-background-color: #238296;
  --button-cta-hover-border-color: transparent;
  --button-cta-hover-text-color: #fff;
  --button-cta-active-background-color: #004e6e;
  --button-cta-active-text-color: #fff;
  --button-cta-active-border-color: transparent;
  --button-cta-disabled-background-color: var(--disabled-01);
  --button-cta-disabled-text-color: #666;
  ...
  --selectable-card-icon-color: var(--text-01);
  --selectable-card-icon-diabled-color: #C2C2C2;
  ...
  --checkbox-disabled-background-color: #ffffff;
  ...
  --circle-toggle-checkmark-border-color: #FFFFFF;
  ...
  --dropdown-group-section-background-color: rgba(236, 236, 236, 0.5);
  ...
  --formfield-bottom-padding: 10px;
  --formfield-icon-size: 24px;
  --formfield-label-color: #000;
  --formfield-control-color: #333;
  ...
  --formfield-readonly-border-color: #767676;
  ...
  --formfield-outline-focus-box-shadow: var(--focus-box-shadow);
  --formfield-outline-control-font-size: 0.875rem;
  --formfield-outline-control-line-height: normal;
  --formfield-outline-control-font-weight: normal;
  --formfield-outline-control-letter-spacing: normal;
  --formfield-outline-label-font-size: 0.875rem;
  --formfield-outline-label-line-height: normal;
  --formfield-outline-label-font-weight: normal;
  --formfield-outline-label-letter-spacing: 0;
  --formfield-outline-label-height: 22px;
  --formfield-outline-floating-distance: -24px;
  --formfield-outline-hint-spacing: 8px;
  --formfield-outline-hint-font-size: 0.875rem;
  --formfield-outline-hint-line-height: 28px;
  --formfield-outline-hint-font-weight: normal;
  --formfield-outline-hint-letter-spacing: normal;
  --formfield-outline-input-native-placeholder-font-size: var(--formfield-outline-control-font-size);
  --formfield-outline-input-native-placeholder-line-height: var(--formfield-outline-control-height);
  ...
  --link-disabled-color: var(--disabled-01);
  --link-black-color: var(--text-01);
  --link-black-hover-color: #999999;
  ...
  --tab-item-border-color: var(--interactive-text);
  --tab-item-disabled-color: var(--disabled-01);
  --tab-item-disabled-border-color: var(--disabled-01);
  --tab-item-disabled-negative-color: rgba(255, 255, 255, 0.4);
  --tab-item-disabled-negative-border-color: rgba(255, 255, 255, 0.4);
  ...
  --toggle-button-hover-background-color: var(--button-secondary-hover-background-color);
  --toggle-button-hover-border-color: var(--hover-primary);
  --toggle-button-hover-text-color: var(--button-secondary-hover-text-color);
  --toggle-button-active-background-color: var(--button-secondary-active-background-color);
  --toggle-button-active-border-color: var(--active-primary);
  --toggle-button-active-text-color: var(--button-secondary-active-text-color);
  --toggle-button-disabled-background-color: #FFFFFF;
  --toggle-button-disabled-border-color: var(--disabled-01);
  --toggle-button-disabled-text-color: var(--disabled-01);
  --toggle-button-disabled-selected-background-color: var(--disabled-01);
  --toggle-button-disabled-selected-border-color: transparent;
  --toggle-button-disabled-selected-text-color: #fff;
