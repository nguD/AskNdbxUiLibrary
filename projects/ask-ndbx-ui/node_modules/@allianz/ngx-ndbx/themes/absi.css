:root {
  ...
  --interactive-primary: #f7d900;
  --hover-primary: #f7d900;
  --hover-secondary: #ECECEC;
  --active-primary: #e9ce00;
  --hover-link: #f7d900;
  --focus-box-shadow: 0 0 0 2px #ffffff, 0 0 0 6px #f7d900;
  --focus-inset-box-shadow: inset 0 0 0 4px #f7d900, inset 0 0 0 6px #ffffff;
  --text-01: #000000;
  --text-02: #FFFFFF;
  --info: #496EBD;
  --warning: #EFBE25;
  ...
  --accordion-light-font-size: 20px;
  --accordion-light-line-height: var(--paragraph-01-line-height);
  --accordion-light-font-weight: 600;
  --accordion-light-letter-spacing: var(--paragraph-01-letter-spacing);
  --accordion-light-mobile-font-size: 18px;
  --accordion-light-mobile-line-height: 28px;
  ...
  --accordion-light-chevron-color: var(--text-01);
  ...
  --button-primary-text-color: var(--text-01);
  --button-primary-hover-background-color: var(--interactive-primary);
  --button-primary-hover-border-color: transparent;
  --button-primary-hover-text-color: #606060;
  --button-primary-active-background-color: var(--interactive-primary);
  --button-primary-active-text-color: #606060;
  --button-primary-active-border-color: transparent;
  --button-primary-disabled-background-color: rgba(247, 217, 0, 0.65);
  --button-primary-disabled-text-color: rgba(96, 96, 96, 0.65);
  --button-primary-disabled-border-color: transparent;
  --button-secondary-background-color: #000000;
  --button-secondary-border-color: transparent;
  --button-secondary-text-color: #ffffff;
  --button-secondary-hover-background-color: #000000;
  ...
  --button-secondary-disabled-background-color: rgba(0, 0, 0, 0.65);
  --button-secondary-disabled-text-color: rgba(255, 255, 255, 0.65);
  --button-secondary-disabled-border-color: transparent;
  --button-tertiary-background-color: transparent;
  --button-tertiary-border-color: transparent;
  --button-tertiary-text-color: var(--button-primary-text-color);
  ...
  --button-tertiary-disabled-text-color: var(--button-secondary-disabled-background-color);
  ...
  --card-background-selected-color: #ffffff;
  ...
  --checkbox-border-color: var(--text-01);
  --checkbox-icon-color: var(--text-01);
  --checkbox-indeterminate-color: var(--text-01);
  --checkbox-selected-background-color: transparent;
  --checkbox-selected-border-color: var(--text-01);
  --checkbox-hover-background-color: transparent;
  --checkbox-hover-border-color: var(--hover-primary);
  --checkbox-active-background-color: transparent;
  --checkbox-active-border-color: var(--text-01);
  --checkbox-disabled-border-color: #e6e6e6;
  --checkbox-disabled-background-color: #e6e6e6;
  --checkbox-disabled-selected-background-color: transparent;
  --checkbox-disabled-icon-color: #e6e6e6;
  ...
  --datefield-cell-selected-color: var(--text-01);
  ...
  --dropdown-filter-input-active-text-color: var(--text-01);
  ...
  --list-icon-color: var(--active-primary);
  --list-icon-size: 24px;
  ...
  --radio-button-circle-color: var(--text-01);
  --radio-button-hover-circle-color: var(--hover-primary);
  --radio-button-hover-dot-color: var(--radio-button-circle-color);
  --radio-button-selected-dot-color: var(--radio-button-circle-color);
  --radio-button-selected-circle-color: var(--radio-button-circle-color);
  ...
  --radio-button-small-label-font-size: 16px;
  ...
  --toggle-button-disabled-selected-text-color: rgba(255, 255, 255, 0.4);
  ...
  --accordion-chevron-color: var(--text-01);
  --accordion-light-color: var(--text-01); }
