:root {
  ...
  --accordion-regular-font-size: var(--paragraph-03-font-size);
  --accordion-regular-line-height: var(--paragraph-03-line-height);
  --accordion-regular-font-weight: var(--paragraph-03-font-weight);
  --accordion-regular-letter-spacing: var(--paragraph-03-letter-spacing);
  ...
  --accordion-light-font-size: var(--paragraph-03-font-size);
  --accordion-light-line-height: var(--paragraph-03-line-height);
  --accordion-light-font-weight: var(--paragraph-03-font-weight);
  --accordion-light-letter-spacing: var(--paragraph-03-letter-spacing);
  ...
  --accordion-regular-chevron-color: var(--text-01);
  --accordion-regular-hover-chevron-color: var(--interactive-text);
  --accordion-disabled-color: var(--disabled-01);
  --accordion-regular-header-background-color: #F5F5F5;
  --accordion-regular-header-text-color: var(--text-01);
  --accordion-regular-header-hover-text-color: var(--interactive-text);
  --accordion-regular-header-top-margin: 0;
  --accordion-regular-border-color: #999999;
  --accordion-regular-header-padding: 16px;
  --accordion-regular-body-padding: 16px 24px;
  --accordion-light-header-text-color: var(--text-01);
  ...
  --button-primary-disabled-text-color: rgba(255, 255, 255, 0.4);
