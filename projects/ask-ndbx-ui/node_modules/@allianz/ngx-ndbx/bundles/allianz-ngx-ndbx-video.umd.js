(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/coercion'), require('@angular/platform-browser'), require('@angular/common'), require('@allianz/ngx-ndbx/icon')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/video', ['exports', '@angular/core', '@angular/cdk/coercion', '@angular/platform-browser', '@angular/common', '@allianz/ngx-ndbx/icon'], factory) :
    (global = global || self, factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].video = {}), global.ng.core, global.ng.cdk.coercion, global.ng.platformBrowser, global.ng.common, global.allianz['ngx-ndbx'].icon));
}(this, (function (exports, core, coercion, platformBrowser, common, icon) { 'use strict';
