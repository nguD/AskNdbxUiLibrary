(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/button'), require('@angular/core'), require('@angular/cdk/keycodes'), require('@angular/cdk/coercion'), require('@allianz/ngx-ndbx/icon'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/sidebar', ['exports', '@allianz/ngx-ndbx/button', '@angular/core', '@angular/cdk/keycodes', '@angular/cdk/coercion', '@allianz/ngx-ndbx/icon', '@angular/common'], factory) :
    (global = global || self, factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].sidebar = {}), global.allianz['ngx-ndbx'].button, global.ng.core, global.ng.cdk.keycodes, global.ng.cdk.coercion, global.allianz['ngx-ndbx'].icon, global.ng.common));
}(this, (function (exports, button, core, keycodes, coercion, icon, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NxSidebarToggleComponent = /** @class */ (function (_super) {
        ...
        NxSidebarToggleComponent.ctorParameters = function () { return [
            { type: core.ChangeDetectorRef },
            { type: core.ElementRef },
            { type: NxSidebarComponent, decorators: [{ type: core.Optional }, { type: core.Host }] }
        ]; };
    ...
    var NxSidebarModule = /** @class */ (function () {
        ...
        NxSidebarModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, icon.NxIconModule, button.NxButtonModule],
    ...
    exports.NxSidebarFooterComponent = NxSidebarFooterComponent;
    exports.NxSidebarModule = NxSidebarModule;
    exports.NxSidebarToggleComponent = NxSidebarToggleComponent;
