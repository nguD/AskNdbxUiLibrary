(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@allianz/ngx-ndbx/progressbar'), require('@angular/cdk/coercion'), require('@angular/core'), require('@angular/common'), require('@angular/cdk/stepper'), require('rxjs/operators'), require('@allianz/ngx-ndbx/utils'), require('rxjs'), require('@angular/cdk/bidi'), require('@allianz/ngx-ndbx/icon'), require('@allianz/ngx-ndbx/base')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/progress-stepper', ['exports', '@allianz/ngx-ndbx/progressbar', '@angular/cdk/coercion', '@angular/core', '@angular/common', '@angular/cdk/stepper', 'rxjs/operators', '@allianz/ngx-ndbx/utils', 'rxjs', '@angular/cdk/bidi', '@allianz/ngx-ndbx/icon', '@allianz/ngx-ndbx/base'], factory) :
    (global = global || self, factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx']['progress-stepper'] = {}), global.allianz['ngx-ndbx'].progressbar, global.ng.cdk.coercion, global.ng.core, global.ng.common, global.ng.cdk.stepper, global.rxjs.operators, global.allianz['ngx-ndbx'].utils, global.rxjs, global.ng.cdk.bidi, global.allianz['ngx-ndbx'].icon, global.allianz['ngx-ndbx'].base));
}(this, (function (exports, progressbar, coercion, core, common, stepper, operators, utils, rxjs, bidi, icon, base) { 'use strict';
    ...
    ***************************************************************************** */
            ...
            function (value) {
                ...
                if (this._stepControl) {
                    this._stepControl.statusChanges
                        .pipe(operators.takeUntil(this._destroyed), operators.takeWhile((/**
                     * @return {?}
                     */
    ...
    var NxProgressStepperDirective = /** @class */ (function (_super) {
        ...
        function () {
            ...
            function (step) {
                step.stepControl.statusChanges
                    .pipe(operators.takeUntil(step._destroyed))
                    .subscribe((/**
                 * @return {?}
                 */
                function () {
        ...
        NxProgressStepperDirective.propDecorators = {
            _steps: [{ type: core.ContentChildren, args: [NxStepComponent, { descendants: true },] }],
    ...
    var NxMultiStepperGroupComponent = /** @class */ (function () {
        ...
        NxMultiStepperGroupComponent.propDecorators = {
            steps: [{ type: core.ContentChildren, args: [NxStepComponent, { descendants: true },] }],
            label: [{ type: core.Input }]
        };
    ...
    var NxMultiStepperComponent = /** @class */ (function (_super) {
        ...
        NxMultiStepperComponent.propDecorators = {
            groups: [{ type: core.ContentChildren, args: [NxMultiStepperGroupComponent, { descendants: true },] }],
            direction: [{ type: core.Input }]
        };
    ...
    exports.NxMultiStepperGroupComponent = NxMultiStepperGroupComponent;
