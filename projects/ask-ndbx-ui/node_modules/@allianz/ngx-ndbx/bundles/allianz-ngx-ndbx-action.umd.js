(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/cdk/coercion'), require('@allianz/ngx-ndbx/icon')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/action', ['exports', '@angular/core', '@angular/common', '@angular/cdk/coercion', '@allianz/ngx-ndbx/icon'], factory) :
    (global = global || self, factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].action = {}), global.ng.core, global.ng.common, global.ng.cdk.coercion, global.allianz['ngx-ndbx'].icon));
}(this, (function (exports, core, common, coercion, icon) { 'use strict';

    /**
     * @fileoverview added by tsickle
     * Generated from: action-icon.directive.ts
    ...
    var NxActionComponent = /** @class */ (function () {
        ...
        NxActionComponent.propDecorators = {
            _iconChild: [{ type: core.ContentChild, args: [NxActionIconDirective, { static: false },] }],
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: action.module.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
