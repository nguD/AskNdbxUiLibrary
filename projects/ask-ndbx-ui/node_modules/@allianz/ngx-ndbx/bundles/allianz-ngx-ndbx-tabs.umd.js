(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/portal'), require('@angular/common'), require('@allianz/ngx-ndbx/accordion'), require('rxjs'), require('@angular/cdk/coercion'), require('@angular/cdk/a11y'), require('@angular/cdk/keycodes')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/tabs', ['exports', '@angular/core', '@angular/cdk/portal', '@angular/common', '@allianz/ngx-ndbx/accordion', 'rxjs', '@angular/cdk/coercion', '@angular/cdk/a11y', '@angular/cdk/keycodes'], factory) :
    (global = global || self, factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].tabs = {}), global.ng.core, global.ng.cdk.portal, global.ng.common, global.allianz['ngx-ndbx'].accordion, global.rxjs, global.ng.cdk.coercion, global.ng.cdk.a11y, global.ng.cdk.keycodes));
}(this, (function (exports, core, portal, common, accordion, rxjs, coercion, a11y, keycodes) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NxTabGroupComponent = /** @class */ (function () {
        ...
        */
        ...
        NxTabGroupComponent.propDecorators = {
            ...
            accordion: [{ type: core.ViewChild, args: [accordion.NxAccordionDirective, { static: false },] }],
            selectedIndex: [{ type: core.Input }],
    ...
    exports.ɵb = NxTabLabelWrapperDirective;
    exports.ɵc = NxTabHeaderOutletComponent;
