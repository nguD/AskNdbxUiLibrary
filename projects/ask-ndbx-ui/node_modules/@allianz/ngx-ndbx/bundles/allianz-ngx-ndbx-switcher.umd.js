(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/cdk/coercion'), require('@allianz/ngx-ndbx/utils'), require('@angular/common'), require('@allianz/ngx-ndbx/icon'), require('@angular/cdk/observers')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/switcher', ['exports', '@angular/core', '@angular/forms', '@angular/cdk/coercion', '@allianz/ngx-ndbx/utils', '@angular/common', '@allianz/ngx-ndbx/icon', '@angular/cdk/observers'], factory) :
    (global = global || self, factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].switcher = {}), global.ng.core, global.ng.forms, global.ng.cdk.coercion, global.allianz['ngx-ndbx'].utils, global.ng.common, global.allianz['ngx-ndbx'].icon, global.ng.cdk.observers));
}(this, (function (exports, core, forms, coercion, utils, common, icon, observers) { 'use strict';
