(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/cdk/coercion'), require('@angular/forms'), require('rxjs'), require('@allianz/ngx-ndbx/base'), require('@allianz/ngx-ndbx/utils'), require('@allianz/ngx-ndbx/icon'), require('@angular/cdk/observers')) :
    typeof define === 'function' && define.amd ? define('@allianz/ngx-ndbx/checkbox', ['exports', '@angular/common', '@angular/core', '@angular/cdk/coercion', '@angular/forms', 'rxjs', '@allianz/ngx-ndbx/base', '@allianz/ngx-ndbx/utils', '@allianz/ngx-ndbx/icon', '@angular/cdk/observers'], factory) :
    (global = global || self, factory((global.allianz = global.allianz || {}, global.allianz['ngx-ndbx'] = global.allianz['ngx-ndbx'] || {}, global.allianz['ngx-ndbx'].checkbox = {}), global.ng.common, global.ng.core, global.ng.cdk.coercion, global.ng.forms, global.rxjs, global.allianz['ngx-ndbx'].base, global.allianz['ngx-ndbx'].utils, global.allianz['ngx-ndbx'].icon, global.ng.cdk.observers));
}(this, (function (exports, common, core, coercion, forms, rxjs, base, utils, icon, observers) { 'use strict';
